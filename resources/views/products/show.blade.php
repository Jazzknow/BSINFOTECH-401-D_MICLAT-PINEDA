    ...
    <div class="section">
        <div class="container">
            <div class="event-card has-before hover:shine">
                <div class="card-banner img-holder" style="--width: 600; --height: 340;">
                    <img src="{{ asset($product->photo) }}" alt="{{ $product->product_name }}" class="img-cover">
                    <time class="publish-date label-2">{{ $product->price }}</time>
                </div>

                <div class="card-content">
                    <p class="card-subtitle label-2 text-center">{{ $product->sub_name }}</p>
                    ...
                    <div class="card-actions">
                        ...
                        <a href="{{ route('products.index') }}" class="btn-action btn-view">
