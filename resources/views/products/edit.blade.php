...
<body>
    <section class="section edit-form bg-black-10" aria-label="edit-form">
        <div class="container">
            <p class="section-subtitle label-2 text-center">Edit</p>
            <h2 class="section-title headline-1 text-center">Product Details</h2>
            ...
            <div class="form-container">
                <form action="{{ route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="sub_name" class="form-input" value="{{ $product->sub_name }}" required>
                    </div>

                    <div class="form-group">
                        <label for="description" class="label-2">Description</label>
                        <textarea name="description" class="form-input" required>{{ $product->description }}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="photo" class="form-input file-input">
                        @if($product->photo)
                            <div class="current-photo">
                                <img src="{{ asset($product->photo) }}" alt="Current product photo">
                            </div>
                        @endif
                    </div>
